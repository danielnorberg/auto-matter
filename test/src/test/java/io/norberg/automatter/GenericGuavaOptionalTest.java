...
public class GenericGuavaOptionalTest {
  ...
  public void testExactClass() throws Exception {
    final GenericGuavaOptionalFoobarBuilder<String> builder = new GenericGuavaOptionalFoobarBuilder<>();
  ...
  public void testSuperClass() throws Exception {
    final GenericGuavaOptionalFoobarBuilder<CharSequence> builder = new GenericGuavaOptionalFoobarBuilder<>();
    assertThat(builder.build().foo(), is(Optional.<CharSequence>absent()));
    assertThat(builder.foo(Optional.of("hello")).build().foo(), is(Optional.<CharSequence>of("hello")));
  ...
  public void testCopyPresent() throws Exception {
    ...
    assertThat(GenericGuavaOptionalFoobarBuilder.from(builder.build()).build(), is(builder.build()));
  }
